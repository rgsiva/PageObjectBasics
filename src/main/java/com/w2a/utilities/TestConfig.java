...
public class TestConfig{
	...
	public static String from = "rgsiva.it@gmail.com";
	public static String password = "Amma2018#";
	public static String[] to ={"rgsiva.it@gmail.com","sivakumar.ganesan@regence.com"};
